...
const Feature = ({
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 relative z-10 px-10" style={{ color: '#4a81f6' }}>
        {icon}
      </div>
      <div className="text-lg font-bold mb-2 relative z-10 px-10">
        <div 
          className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-gray-300 transition-all duration-200 origin-center"
          style={{
            backgroundColor: 'rgba(74, 129, 246, 0.3)',
          }}
        />
        <span 
